            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" name="colly_description" id="colly_description" class="form-control  @error('colly_description') is-invalid @enderror" value="{{ $editing ? old('colly_description', $product->colly_description) : old('colly_description') }}" placeholder="10 Kotak">
                    </div>
