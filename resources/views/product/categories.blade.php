...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            ...
            <form id="category-form" action="{{ $editing ? route('master.category.update', $categories) : route('master.category.store') }}"
                method="POST">
                @csrf
                @if ($editing)
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input"
                                ...
                                id="status"
                                name="status"
                                {{ $editing ? old('status', ($categories->status ? 'checked' : '')) : 'checked' }}>
        ...
        */
        ...
        document.addEventListener('click', (e) => {
            ...
            if (editBtn) {
                ...
                let editUrl = "{{ route('master.category.edit', ':id') }}";
            ...
            if (deleteBtn) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let deleteUrl =
                            "{{ route('master.category.destroy', ':id') }}";
                        deleteUrl =
